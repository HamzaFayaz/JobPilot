...
from backend.app.services.browser_agent.linkedin_urls import linkedin_jobs_search_url, linkedin_posts_search_url
from backend.app.services.browser_agent.models import RawJobListing, WorkerTask
from backend.app.services.browser_agent.parse import (
...
from backend.app.services.browser_agent.prompts import (
...
from backend.app.services.browser_agent.browser_protocol import BrowserCommandClient
from backend.app.services.browser_agent.run_metrics import (
    LlmCallMetrics,
    PhaseMetrics,
    PhaseRunResult,
    save_run_summary,
...
from backend.app.services.browser_agent.snapshot_store import (
    POSTS_DOM_PROBE_JS,
    save_activity_urls,
...
from backend.app.services.browser_agent.webbridge_tools import WEBBRIDGE_TOOL_DEFINITIONS
from backend.app.services.browser_agent.webbridge_scroll import (
    JOB_DETAIL_WAIT_MS,
...
def _build_client(settings: BrowserAgentSettings) -> OpenAI:
    return OpenAI(
...
async def _bootstrap_search_page(
    *,
    webbridge: BrowserCommandClient,
    settings: BrowserAgentSettings,
    session: str,
    phase: Phase,
    task: WorkerTask,
